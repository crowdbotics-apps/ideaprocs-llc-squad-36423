...
## Project Structure
    ...
    ├── ideaprocs_llc_squad_36423  # Django project configurations
...
1. Clone this repo and `cd ideaprocs_llc_squad_36423`
...
2. Clone this repo and `cd ideaprocs_llc_squad_36423`
